...
exports.draftCmd = void 0;
const builders_1 = require("@discordjs/builders");
exports.draftCmd = new builders_1.SlashCommandBuilder()
    .setName('draft')
    ...
    .addSubcommand((subcommand) => subcommand.setName('cancel').setDescription('Cancel the current draft'));
