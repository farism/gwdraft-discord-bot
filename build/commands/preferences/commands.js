...
exports.preferencesCmd = void 0;
const builders_1 = require("@discordjs/builders");
const commands_1 = require("../rank/commands");
exports.preferencesCmd = new builders_1.SlashCommandBuilder()
    .setName('preferences')
    ...
    .addChoices(...commands_1.professionChoices))
    .addStringOption((option) => option
    .setName('2')
